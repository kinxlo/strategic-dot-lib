...
export const TsaFooter: FC<TsaFooterProperties> = ({ footerMaxWidth, footerBgColor, className, ...rest }) => {
  return (
    <div className={cn(`bg-mid-grey-II`, footerBgColor)} {...rest}>
      <footer className={cn(`mx-auto py-14 px-3 lg:px-0 text-white`, className)}>
        <section className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-10">
